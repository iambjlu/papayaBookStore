    ...
    <header class="mdl-layout__header">
        ...
        <div class="mdl-layout__header-row">
            ...
            <nav class="mdl-navigation mdl-layout--large-screen-only">
                ...
                <a class="mdl-navigation__link" href="buy.php" target="imain">購買書籍</a>
    ...
    <main class="mdl-layout__content">
      ...
      <br/>
            ...
            font-size: 24px;width:280px;height:60px;"
                                        onclick="document.getElementById('imain').src='introduction.php';">書籍介紹
                                </button>
                                </a>
                            </td>
                        </tr>
			...
			background-size:100% 100%;">
                            <td width="280" height="60" align="center">
                                <button class="mdl-button mdl-js-button mdl-js-ripple-effect" style="color: #FFFFFF;
            font-size: 24px;width:280px;height:60px;" onclick="document.getElementById('imain').src='buy.php';">購買書籍
                                </button>
                                </a>
                            </td>
                        </tr>
			...
			background-size:100% 100%;">
                            <td width="280" height="60" align="center">
                                <button class="mdl-button mdl-js-button mdl-js-ripple-effect" style="color: #FFFFFF;
            font-size: 24px;width:280px;height:60px;" onclick="document.getElementById('imain').src='order.php';">我的訂單
                                </button>
                                </a>
                            </td>
                        </tr>
